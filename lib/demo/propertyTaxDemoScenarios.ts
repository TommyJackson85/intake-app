...
export const PROPERTY_TAX_DEMO_SCENARIOS: readonly PropertyTaxDemoScenario[] = [
  {
    ...
    purpose:
      'Show a Florida homeowner who reports that an assessment appears too high and has a TRIM / possible VAB issue for firm fact collection.',
    tag: 'Assessment / VAB',
  ...
  return createEmptyPropertyTaxIssue({
    ...
    byKind: {
      assessment_vab: createEmptyAssessmentVabIssue({
        ...
        noticeReceivedDate: { date: '2026-08-20', source: 'client_reported' },
  ...
  return [
    {
      ...
      linkedMatterFileId: assessment.fileId,
    ...
    },
    {
      ...
      clientSubmittedAt: null,
      submittedIntake: null,
      linkedMatterFileId: buyer.fileId,
      conflict_check_status: 'pending',
      conflict_check_completed_at: null,
      conflict_check_note: null,
    },
    {
      ...
      clientSubmittedAt: null,
      submittedIntake: null,
      linkedMatterFileId: taxDeed.fileId,
      conflict_check_status: 'pending',
      conflict_check_completed_at: null,
      conflict_check_note: null,
    },
