...
export const demoSeedData: DemoSeedData = {
  intakeLeads: [
    ...
    {
      id: 'intake-lead-seed-003',
      token: 'demo-token-seed-003',
      createdAt: '2026-04-10T11:00:00.000Z',
      fileReference: 'FL-2026-007',
      emailRecipientName: 'Liv Shaw',
      emailRecipientEmail: 'liv+alias-demo@example.com',
      emailSubject: 'Intake form — FL-2026-007',
      emailBody: '',
      demoDelivery: 'link_saved',
      intake: {
        clientName: 'Liv Shaw',
        clientEmail: 'liv+alias-demo@example.com',
        clientPhone: '(954) 555-0199',
        transactionRole: 'buyer',
        transactionRoleOther: '',
        matterType: 'Financed Residential Purchase',
        propertyAddress: '100 Demo Lane, Orlando, FL 32803',
        county: 'Orange County',
    ...
    {
      id: 'intake-lead-seed-004',
      token: 'demo-token-seed-004',
      createdAt: '2026-04-11T15:00:00.000Z',
      fileReference: 'FL-2026-008',
      emailRecipientName: 'New Prospect',
      emailRecipientEmail: 'prospect+email-match@example.com',
      emailSubject: 'Intake form — FL-2026-008',
      emailBody: '',
      demoDelivery: 'link_saved',
      intake: {
        clientName: 'Unrelated Prospect',
        clientEmail: 'olivia.shaw+demo@example.com',
        clientPhone: '(999) 999-9999',
        transactionRole: 'buyer',
        transactionRoleOther: '',
        matterType: 'Cash Residential Purchase',
        propertyAddress: '200 Sample Rd, Tampa, FL 33602',
        county: 'Hillsborough County',
        targetClosingDate: '2026-08-15',
        notes: 'Demo: email matches seeded client Olivia Shaw',
        buyerType: 'individual',
      },
      status: 'pending_client',
      clientSubmittedAt: null,
