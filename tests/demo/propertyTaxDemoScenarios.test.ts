...
describe('property-tax demo scenarios (Step 6)', () => {
  ...
  it('scenario 1 has only Assessment/VAB issue data and dates', () => {
    ...
    expect(branch.noticeMailingDate).toEqual({ date: '2026-08-18', source: 'client_reported' })
    expect(branch.noticeReceivedDate).toEqual({ date: '2026-08-20', source: 'client_reported' })
