...
|-------------------------|-----------------------------|------------------------------------------|-----------------------------------|----------------------------------------------|
| Marketing leads | marketing_leads | 2 years from last interaction | Legitimate interest | Fields include email, firm_name, state, ip_address, **source** (public_site/firm_integration) | Delete or anonymise after period             |
